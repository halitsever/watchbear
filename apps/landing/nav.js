...
(function () {
  ...
  var STYLE =
    ...
    ".nav{position:sticky;top:0;z-index:50;backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);background:rgba(20,16,11,0.72);border-bottom:1px solid var(--line-soft,rgba(244,196,128,0.1))}" +
    ".wrap{max-width:1180px;margin:0 auto;padding:0 28px}" +
    ".nav-in{display:flex;align-items:center;justify-content:space-between;height:72px}" +
    ".brand{display:flex;align-items:center;gap:12px}" +
    ".brand .mk{width:40px;height:40px;border-radius:50%;overflow:hidden;display:flex;align-items:center;justify-content:center;background:var(--panel2,#241a11)}" +
    ".brand .mk svg{display:block}" +
    ".wordmark{font-family:\"Baloo 2\",system-ui,sans-serif;font-weight:700;font-size:22px;letter-spacing:-0.01em;color:var(--cream,#fbf2e3)}" +
    ".wordmark .w2{color:var(--honey,#f0a830)}" +
    ".nav-right{display:flex;align-items:center;gap:28px}" +
    ".nav-link{font-family:\"Hanken Grotesk\",system-ui,sans-serif;font-weight:500;font-size:15px;color:var(--dim,#c9b095);transition:color 0.2s}" +
    ".nav-link:hover,.nav-link[aria-current=\"page\"]{color:var(--cream,#fbf2e3)}" +
    ".btn{display:inline-flex;align-items:center;gap:9px;font-family:\"Hanken Grotesk\",system-ui,sans-serif;font-weight:700;cursor:pointer;border:none;border-radius:999px;background:linear-gradient(180deg,var(--honey-bright,#ffc560),var(--honey,#f0a830));color:var(--on-honey,#241704);padding:10px 18px;font-size:15px;box-shadow:0 6px 18px rgba(240,168,48,0.3)}" +
    ".nav-toggle{display:none;flex-direction:column;justify-content:center;gap:5px;width:42px;height:42px;padding:0 9px;background:transparent;border:1px solid var(--line,rgba(244,196,128,0.12));border-radius:11px;cursor:pointer}" +
    ".nav-toggle span{display:block;width:100%;height:2px;background:var(--text,#f6ead7);border-radius:2px;transition:transform 0.2s,opacity 0.2s}" +
    ...
    ".nav-right{position:absolute;top:calc(100% + 1px);left:0;right:0;flex-direction:column;align-items:stretch;gap:4px;background:var(--panel,#1c150e);border:1px solid var(--line,rgba(244,196,128,0.12));border-radius:0 0 16px 16px;padding:10px;box-shadow:0 28px 50px rgba(0,0,0,0.45);display:none;z-index:50}" +
    ".nav.open .nav-right{display:flex}" +
    ".nav-right .nav-link{padding:12px 14px;border-radius:10px;font-size:15px}" +
    ".nav-right .nav-link:hover{background:rgba(244,196,128,0.05)}" +
